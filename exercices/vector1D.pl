...
template=/cpp-info111/exercices_src/vector1D/metadata.pl
...
@ /cpp-info111/exercices_src/vector1D/recherche_wright.cpp
@ /cpp-info111/exercices_src/vector1D/sum_input.cpp
@ /cpp-info111/exercices_src/vector1D/tri_code.cpp
